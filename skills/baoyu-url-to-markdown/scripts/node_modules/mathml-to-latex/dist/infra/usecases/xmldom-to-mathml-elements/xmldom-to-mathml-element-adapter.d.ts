...
export declare class XmlToMathMLAdapter {
    private _xml;
    private readonly _xmlDOM;
    private readonly _errorHandler;
    private readonly _elementsConvertor;
    ...
    private _removeMsWordPrefixes;
    private get _mathMLElements();
}
